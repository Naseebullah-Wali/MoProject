        ...
        <tbody>
          <tr v-for="item in paginatedAndFilteredData" :key="item.id">
            <td v-for="col in visibleColumns" :key="col">
              <div v-if="imageColumns.includes(col.toLowerCase())">
...
// List of columns that might contain image URLs
const imageColumns = ['company_logo', 'flag', 'other_image_column']; // Add all possible image column names here
